...
%ADB% %DEVICE% shell pm list packages com.HRing.mygoodness
...
%ADB% %DEVICE% shell rm -r %STORAGE%/Download/obb/com.HRing.mygoodness
...
%ADB% %DEVICE% shell pm grant com.HRing.mygoodness android.permission.READ_EXTERNAL_STORAGE
%ADB% %DEVICE% shell pm grant com.HRing.mygoodness android.permission.WRITE_EXTERNAL_STORAGE
